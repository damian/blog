...
So why am I banging on about a blog post someone else has written? I thought it would be a good learning experience to port it over to Bash. I also knew that retrieving image dimensions is trivial using imagemagick(the only pre-requisite).
