...
I wrote a wrapper around an online HTML5 validation service called "validator.nu":http://validator.nu/. When ran as part of an RSpec suite, the rendered HTML is posted to their web service which responds with some JSON containing the results of the validation check.
